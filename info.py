...
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002679595778')) # admin your channel in users log 
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sunnyfbook21:pY62CnoJaudg1wXt@cluster0.brruqsz.mongodb.net/?retryWrites=true&w=majority")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
FQDN = str(getenv('FQDN', 'mmsbee.ilja.org')) if not ON_HEROKU or getenv('FQDN', '') else APP_NAME+'.herokuapp.com'
...
NETLIFY_URL = environ.get('NETLIFY_URL', 'https://mmsbee.ilja.org')
